...
/**
 * Test class for the Tax Controller
 * 
 * @author Alessandro Ciotola
 */
@Ignore
@RunWith(Arquillian.class)
public class TaxControllerDBTest {
    
    @Inject
    private CustomTaxJpaController customTaxController;
    ...
    /**
     * Test which will check if the correct Tax is returned by searching by id.
     * 
     * @throws SQLException
     */
    @Test
    public void findTaxByIdTest() throws SQLException
    {
        Tax tax = customTaxController.getTaxByID(1);
        log.log(Level.INFO, "Data>>>{0}", tax.getGst());
        assertEquals(tax.getGst().doubleValue(), 14.975, 0);
    }
    
    /**
     * Test which will check if the correct Tax is returned by searching by province.
     * 
     * @throws SQLException
     */
    @Test
    public void findTaxByProvinceTest() throws SQLException
    {
        Tax tax = customTaxController.getTaxByProvince("Quebec");
        log.log(Level.INFO, "Data>>>{0}", tax.getGst());
        assertEquals(tax.getGst().doubleValue(), 14.975, 0);
    }
    ...
    public static WebArchive deploy()
    {
        ...
        final WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "tests.war")
                ...
                .addPackage(TaxControllerDBTest.class.getPackage())
