...
/**
 * This class allow to query the result of the books that have never been sold
 * between two dates.
 *
...
@Named("zeroSale")
@SessionScoped
public class ZeroSaleBackingBean implements Serializable{
    
    private final Logger log = Logger.getLogger(ZeroSaleBackingBean.class.getName());
    ...
    public List<Book> getData() {               
        ...
        List<Book> result = manController.allBookNeverSold(startDate, endDate);
